...
class CaraotaEntertainmentNews:
    ...
    req = http.request('GET', CaraotaCommons.entertainmentNewsEndpoint,
    ...
    def getEntertainmentNews(self):
        ...
        for news in self.redNewsCategory:
        ...
        self.db.child("entertainmentNews").child("news").remove()
        self.db.child("entertainmentNews").child("news").set(entertaimentNews)
