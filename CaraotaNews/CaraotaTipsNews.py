...
class CaraotaTipsNews:
    ...
    req = http.request('GET', CaraotaCommons.tipsNewsEndpoint,
    ...
    tipNewsBody = soup.find_all(ARTICLES_DIV_KEY, ARTICLES_DIV_ClASS_NAME)
    ...
    def getTipsNews(self):
        tipNews = []

        for news in self.tipNewsBody:
        ...
        self.db.child("tipNews").remove()
        self.db.child("tipNews").set(tipNews)
